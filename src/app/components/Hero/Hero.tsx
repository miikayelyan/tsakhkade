...
export default function Hero() {
  ...
  return (
    <main>
      <section className="grid grid-cols-2 grid-rows-[250px_810px] px-4 pt-4 pb-9">
        ...
        <div className="flex flex-col items-center row-start-2 row-end-3 w-[708px] z-10">
        ...
        <div className="flex flex-col items-center row-end-3 w-[708px] z-10">
          <motion.div ref={targetRef} style={{ y, scale }}>
            <video
